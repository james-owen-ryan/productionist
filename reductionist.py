...
class Reductionist(object):
    ...
    def __init__(self, path_to_input_content_file, path_to_write_output_files_to, trie_output, verbosity=1):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--trie_output',
        help="whether to include trie keys in the .meanings files or the fully expanded grammar paths (flag "
             "argument); this should only be used for Productionist modules that are built in Python and can "
             "use the marisa_trie package to restore trie keys",
        action="store_true"
    )
    parser.add_argument(
        "--verbosity",
