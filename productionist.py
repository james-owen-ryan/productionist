...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "content_bundle_name",
        help="the name of the content bundle that is to be operated over (i.e., 'talktown' to use files " +
             "generated by Reductionist that are named 'talktown.grammar', 'talktown.trie', and 'talktown.meanings'"
    )
    parser.add_argument(
        "content_bundle_dir",
